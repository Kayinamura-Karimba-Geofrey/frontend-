...
export default function Sidebar({ activeNav, setActiveNav, role, isCollapsed, toggleCollapse }) {
  const allNavItems = [
    ...
    { id: 'classes', label: 'School Classes', icon: ShieldCheck, roles: ['ROLE_ADMIN', 'ROLE_TEACHER'] },
    { id: 'subjects', label: 'Subjects & Curriculum', icon: BookOpen, roles: ['ROLE_ADMIN', 'ROLE_TEACHER'] },
